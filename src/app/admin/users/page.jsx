                                ...
                                {users?.map((user) => (
                                    <tr
                                        ...
                                        className={`border-primary ${
                                            user === users[users.length - 1] ? "border-none" : "border-b"
                                        }`}
                                    >
                                        <td className="py-3 px-5">
                                            <div className="w-max font-medium capitalize">{user.name}</div>
                                        </td>
                                        <td className="py-3 pr-5 text-sm">
                                            <div className="w-max">{user.email}</div>
                                        </td>
                                        <td className="py-3 pr-5">
                                            <div className="w-max capitalize text-sm">{user.role}</div>
                                        </td>
                                        <td className="py-3 pr-5">
                                            ...
                                            <div className="w-max capitalize text-sm">
                                                {user.status === "active" ? (
                                                    <p className="py-0.5 px-2 rounded flex items-center gap-x-1">
                                                        <span className="w-2 h-2 inline-block rounded-full bg-[#2F9A48]" />
                                                        {user.status}
                                                    </p>
                                                ) : (
                                                    <p className="py-0.5 px-2 rounded flex items-center gap-x-1">
