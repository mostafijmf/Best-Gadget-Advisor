    ...
    return (
        <>
            <div className="lg:hidden min-w-min grid place-items-center relative">
                ...
                <ul
                    className={`absolute top-14 right-0 w-80 h-min bg-white flex flex-col list-none text-primary text-lg rounded-md overflow-hidden shadow-lg duration-300 origin-right ${
                        openMenu ? "scale-100 translate-x-0" : "scale-x-0 translate-x-10"
                    }`}
                >
                    <li>
                        <Link
                            ...
                            className={`px-10 py-3 hover:bg-orange-50 w-full h-max block hover:text-secondary duration-200 ${
                                currentPath === "/" && "text-secondary bg-orange-50"
                            }`}
                        >
                            Home
                        </Link>
                    ...
                    <li>
                        <Link
                            ...
                            className={`px-10 py-3 hover:bg-orange-50 w-full h-max block hover:text-secondary duration-200 ${
                                currentPath === "/product-reviews" && "text-secondary bg-orange-50"
                            }`}
                        >
                            Product Reviews
                        </Link>
                    ...
                    <li>
                        <Link
                            href={"/contact"}
                            className={`px-10 py-3 hover:bg-orange-50 w-full h-max block hover:text-secondary duration-200 ${
                                currentPath === "/contact" && "text-secondary bg-orange-50"
                            }`}
                        >
                            Contact
                        </Link>
                    ...
                    <li>
                        <Link
                            href={"/about"}
                            className={`px-10 py-3 hover:bg-orange-50 w-full h-max block hover:text-secondary duration-200 ${
                                currentPath === "/about" && "text-secondary bg-orange-50"
                            }`}
                        >
                            About
                        </Link>
